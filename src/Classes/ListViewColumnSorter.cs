...
namespace trakr_sharp {
    ...
    class ListViewColumnSorter : IComparer {
        ...
        private readonly List<int> textualCols = new List<int>() { 1, 6, 7 };
        private readonly List<int> dateCols = new List<int>() { 3, 5 };
        ...
        public int Compare(object x, object y) {
            ...
            // Compare the two items (either numerically, textually or date wise depending on ColumnToSort value)
            if (textualCols.Contains(ColumnToSort)) {
                compareResult = ObjectCompare.Compare(listviewX.SubItems[ColumnToSort].Text, listviewY.SubItems[ColumnToSort].Text);
            }
            else if (numericCols.Contains(ColumnToSort)) {
                ...
                dateX = Utils.Times.LogicalDateStringToDateTime(listviewX.SubItems[ColumnToSort].Text);
                dateY = Utils.Times.LogicalDateStringToDateTime(listviewY.SubItems[ColumnToSort].Text);
